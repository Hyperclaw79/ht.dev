...
jest.unstable_mockModule('../../../../src/routes/api/education/getter.js', () => {
    return {
...
const { GET, POST, PUT, DELETE } = await import("../../../../src/routes/api/education/+server.js");
...
describe("GET method", () => {
    ...
    it("should handle getter function being called with correct parameters", async () => {
        ...
        const getterModule = await import("../../../../src/routes/api/education/getter.js");
