<script>
    export let name, title, description, imageUrl, tags;
    /* eslint-disable no-undef-init */
    export let htmlUrl = undefined;
    export let watcherCount = undefined;
    export let stargazerCount = undefined;
    export let forkCount = undefined;
    export let oddOrEven = undefined;
    ...
    $: allStatsPresent = Object.values(stats).every(stat => stat.count !== undefined);
...
>
    <div
        class="ghCard"
        style="transform: translateX({2 * Math.pow(-1, oddOrEven)}0vw);"
        class:clearTX={inview}
    >
